...
DesignForm::DesignForm( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
    m_sFormId = "";
    m_Toolbar = nullptr;
    m_StatusBar = nullptr;
...
void DesignForm::SetFormID(wxString sPageId)
{
    m_sFormId=sPageId;
}
